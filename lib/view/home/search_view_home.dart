...
class SearchViewHome extends StatefulWidget {
  ...
  const SearchViewHome({super.key, required this.songHandler});

  @override
  State<SearchViewHome> createState() => _SearchViewState();
}

class _SearchViewState extends State<SearchViewHome> {
